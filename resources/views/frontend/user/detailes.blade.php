        ...
        <div class="about-me container">
            ...
            <div class="row">
                <div class="col-lg-4" data-aos="fade-right">
                    <img src="{{(!empty($user->image))?url('images/user/'.$user->image):url('images/user/profile.jpg')}}" class="img-fluid" alt=""
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                            ...
                            <ul>
                                <li><i class="icofont-rounded-right"></i> <strong
                                        ...
                                        style="color:#174044;font-size:13px;">{{$user->course_name}} <small
                                            style="font-size:7px;color:#581845;">{{$user->course_quali}}</small>
                                    </b></li>
                                <li><i class="icofont-rounded-right"></i> <strong
                        ...
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="icofont-rounded-right"></i> <strong
                                        ...
                                        style="color:#174044;font-size:13px;"> {{$user->cell}} </b></li>
                                <li><i class="icofont-rounded-right"></i> <strong
                    ...
                    <ul class="social-nav model-3d-0 footer-social w3_agile_social two">
                        <li><a target="_blank" href="{{$user->facelink}}" class="facebook">
                        ...
                        <li><a target="_blank" href="{{$user->linlink}}" class="linkedin">
                        ...
                        <li><a target="_blank" href="mailto:{{$user->email}}" class="email">
                        ...
                        <li><a target="_blank" href="tel:+88{{$user->phone}}" class="phone">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                    <div class="count-box">
                        ...
                        <p style="color:orange;fon-weight:400;font-size:11px;">{{$user->intname}}</p>
                    </div>
                </div>
