            ...
            <div class="panel panel-primary">
                ...
                <form class="form-horizontal" action="{{route('service.update', $service->id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input value="{{$service->sub_title}}" name="sub_title" type="text" id="sub_title" class="form-control" placeholder="Service sub_title">
                                @error('sub_title')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="5" placeholder="Service Description">{{$service->description}}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
