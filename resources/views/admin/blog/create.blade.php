                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input value="{{old('title')}}" name="title" type="text" id="title" class="form-control" placeholder="blog title">
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="5" placeholder="blog Description">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">blog Status</label>
                            <div class="col-md-10">
