    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">List Of page</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="{{route('dashboard')}}">Dashboard</a></li>
                    <li><a href="{{route('page.create')}}">Create New</a></li>
                ...
                <div class="panel-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" >Facebook Page Link</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div style="width:110px; height:90px;overflow:hidden">
                                        <img src="{{ asset($page->image) }}" style="width:100px; height:80px;overflow:hidden" alt="">
                                    </div>

                                </td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('page.edit', $page->id) }}"><i class="fa fa-edit"></i></a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('page.destroy', $page->id) }}">
                                        @csrf
                                        @method('delete')
