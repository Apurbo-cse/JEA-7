                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-success d-inline-block" href="{{ route('post.show', $post->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a class="btn btn-info d-inline-block" href="{{ route('post.edit', $post->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
